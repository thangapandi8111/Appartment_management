...
$reasontomeet=$_POST['reasontomeet'];
 $query=mysqli_query($con,"insert into tblvisitor(categoryName,VisitorName,MobileNumber,Address,WhomtoMeet,ReasontoMeet,Apartment,Floor) value('$catname','$visname','$mobnumber','$add','$whomtomeet','$reasontomeet','$apart','$floor')");
